...
opts = Trollop::options do
  ...
  opt :medium, "Pass 'firefox','chrome' or 'safari' ", :type => :string, :required => true
...
Trollop::die :medium, "Pass 'firefox','chrome' or 'safari'"if opts[:medium] == nil
...
mer_utility_object.launch(medium)
